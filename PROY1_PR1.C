...
void main()
{
	...
	gotoxy(34,6); printf("DESCRIPCION");
	gotoxy(50,6); printf("NUMERO DE");gotoxy(52,7); printf("PLACA");
	...
	do
	{
		...
		default: gotoxy(5,26);clreol(); printf("\nLa opcion elegida no existe"); pv=0; getch();
	     }
	} while(pv==0);
	...
	gotoxy(5,16);printf("CANTIDAD DE PLACA TAXI: %d",cpt);
	gotoxy(5,17);printf("CANTIDAD DE PLACA DE BUSES: %d",cpb);
	gotoxy(5,18);printf("CANTIDAD DE PLACA PARTICULARES: %d\n",cpp);
	yp++;
     }
	else
	{
	gotoxy(5,19); printf("Introduzca un valor positivo");
	}
